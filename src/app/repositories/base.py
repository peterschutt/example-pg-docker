...
from starlite import OptionalDependency
...
class AbstractBaseRepository(ABC, Generic[DbType, ReturnType]):
    ...
    def __init__(
        self,
        limit_offset: LimitOffset | None = OptionalDependency(default=None),
        updated_filter: BeforeAfter | None = OptionalDependency(default=None),
    ) -> None:
        """
